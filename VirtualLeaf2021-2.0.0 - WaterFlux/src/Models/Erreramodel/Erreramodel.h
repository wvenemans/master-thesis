...
class Erreramodel : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
        Q_PLUGIN_METADATA(IID "org.virtualleaf.Erreramodel")
...
public:
	...
	//virtual QString DefaultLeafML(void) { return QString("Erreramodel_twocell.xml"); }
};
