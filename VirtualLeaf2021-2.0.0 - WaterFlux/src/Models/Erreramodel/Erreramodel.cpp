...
#include "wallbase.h"
#include "cellbase.h"
#include "Erreramodel.h"

static const std::string _module_id("$Id$");

QString Erreramodel::ModelID(void) {
  // specify the name of your model here
  return QString( "Thesis Willem: Errera based division" );
}

// return the number of chemicals your model 
int Erreramodel::NChem(void) { return 1; }

// To be executed after cell divisi
void Erreramodel::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
  // rules to be executed after cell division go here
  // (e.g., cell differentiation rules)
}

void Erreramodel::SetCellColor(CellBase *c, QColor *color) { 
...
void Erreramodel::CellHouseKeeping(CellBase *c) {
...
void Erreramodel::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2) {
...
void Erreramodel::WallDynamics(Wall *w, double *dw1, double *dw2) {
  // add biochemical networks for reactions occuring at walls here
}
void Erreramodel::CellDynamics(CellBase *c, double *dchem) { 
...
//Q_EXPORT_PLUGIN2(Erreramodel, Erreramodel)
