...
class Randomaxis : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
        Q_PLUGIN_METADATA(IID "org.virtualleaf.Randomaxis")
...
public:
	...
	//virtual QString DefaultLeafML(void) { return QString("Randomaxis_twocell.xml"); }
};
