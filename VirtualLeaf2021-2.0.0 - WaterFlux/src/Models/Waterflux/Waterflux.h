...
class Waterflux : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
        Q_PLUGIN_METADATA(IID "org.virtualleaf.Waterflux")
...
public:
	...
	virtual QString DefaultLeafML(void) { return QString("Waterflux_twocell.xml"); }
};
