...
class Longestaxis : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
        Q_PLUGIN_METADATA(IID "org.virtualleaf.Longestaxis")
...
public:
	...
	//virtual QString DefaultLeafML(void) { return QString("Longestaxis_twocell.xml"); }
};
